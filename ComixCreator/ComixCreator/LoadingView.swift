...
//  ComixCreator
//
//  Created by Svetoslav Dimov on 26.02.23.
//
...
struct LoadingView: View {
    ...
    var body: some View {
        ZStack {
            // S3
            SpinnerCircle(start: spinnerStart, end: spinnerEndS2S3, rotation: rotationDegreeS3, color: .mint)

            // S2
            SpinnerCircle(start: spinnerStart, end: spinnerEndS2S3, rotation: rotationDegreeS2, color: .orange)
